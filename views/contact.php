						...
						<div class="wrapper">
							<div class="row no-gutters">
					        	...
					        	<div class="dbox w-100 d-flex align-items-start">
					        		...
					        		<div class="text pl-3">
						            <p><span>Address:</span> Nabeul mrezgua</p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>Phone:</span> <a href="tel://1234567920">+216 21 333 444 </a></p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>Email:</span> <a href="mailto:info@yoursite.com">yourvacation@gmail.com</a></p>
						          </div>
					          </div>
					        	<div class="dbox w-100 d-flex align-items-center">
					        		<div class="icon d-flex align-items-center justify-content-center">
					        		...
					        		<div class="text pl-3">
						            <p><span>Website</span> <a href="#">yourvacation.com</a></p>
						          </div>
					          </div>
				          </div>
								</div>
