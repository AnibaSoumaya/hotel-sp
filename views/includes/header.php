...
session_start();
define("APPURL","http://localhost/hotel/views");
define("HOTELSIMAGES","http://localhost/hotel/views/admin-panel/hotels-admins/hotel_images");
define("ROOMSIMAGES","http://localhost/hotel/views/admin-panel/rooms-admins/room_images");

?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<title>Your vacation - Free Bootstrap 4 Template by Colorlib</title>
    	<meta charset="utf-8">
  	...
  	<body>
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone :</span> <a href="#">+216 21 333 444</a> or <span class="mailus">email :</span> <a href="#">yourvacation@gmail.com</a></p>
						</div>
		...
		<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
			<div class="container">
				<a class="navbar-brand" href="<?php echo APPURL;?>">Your<span>Vacation</span></a>
