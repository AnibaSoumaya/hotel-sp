...
class Bookingcontroller extends Connexion{
    ...
    return $stmt->execute();
        ...
        public function getCountBoking() {
            ...
            public function searchBookingsByPhoneNumber($phone_number) {
                // Préparez la requête SQL pour rechercher les réservations par numéro de téléphone
                $query = "SELECT * FROM bookings WHERE phone_number LIKE ?";
                $stmt = $this->conn->prepare($query);
                // Ajoutez des wildcards (%) autour du numéro de téléphone pour une recherche partielle
